                ...
                <div className='grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center'>
                    <div className=' lg:w-[32rem] w-full flex flex-col space-y-6'>
                        <div className='text-4xl md:text-5xl font-bold text-[#2e2e2e] lg:text-6xl'>
                            We are <span className='text-blue-900 text-opacity-80'>Serious</span> For <span className='text-[#F79DD0] text-opacity-80'>Food</span> & <span className='text-red-500 text-opacity-70'>Delivery</span>
                        </div>
