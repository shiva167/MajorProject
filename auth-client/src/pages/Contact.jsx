        ...
        <div
            ...
            <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                ...
                <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                    ...
                    <a class="text-red-500 leading-relaxed">tastetracker331@email.com</a>
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">Mobile No.</h2>
                    <p class="leading-relaxed">9123456780</p>
                </div>
            </div>
        </div>
        <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col p-6 md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            <h1 class="text-gray-900 text-3xl font-bold mb-1 font-medium title-font">Contact Us</h1>
